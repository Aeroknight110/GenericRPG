...
namespace GameLibrary {
  public class Rush {
    ...
    private const float INIT_DEF = 3;
    private const float INIT_LUCK = 10;
    private const float INIT_SPEED =10;
    private const float INIT_MANA = 30;

    private const float LVLINC_HEALTH = 10;
    private const float LVLINC_STR = 6;
    private const float LVLINC_DEF = 4;
    private const float LVLINC_LUCK = 5;
    private const float LVLINC_SPEED =6;
